 ...
 * @width: Width is the forth parameter that was entered
...
/**
 * print_int - Print int is the function integer
 * @types: Lista of arguments
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: get width.
 ...
 * @buffer: Buffer array to handle print
 * @flags:  Calculates active flags
 * @width: parameter that hold the width.
 * @precision: Precision specification
 * @size: Size specifier
